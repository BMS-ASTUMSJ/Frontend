...
function UserManagement() {
  ...
  const copyPassword = async () => {
    if (!createdMentorCredentials?.temporaryPassword) return;
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-[#7A7F85]">
              Manage students and mentors with gender filtering
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-[#B3CFE5] bg-white p-12 text-center">
            ...
            <p className="mt-1 text-sm text-[#7A7F85]">
              No {activeTab} match the current search or gender
              filter.
            </p>
          </div>
        ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-3xl bg-white p-6 shadow-2xl sm:p-8">
            ...
            <p className="text-xs text-[#7A7F85]">
              Create a mentor account directly. A temporary password
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm outline-none transition focus:border-[#4A7FA7] focus:ring-2 focus:ring-[#B3CFE5]"
                  />
                </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm outline-none transition focus:border-[#4A7FA7] focus:ring-2 focus:ring-[#B3CFE5]"
                  >
              ...
              <div className="mt-6 flex justify-end gap-3 border-t border-gray-100 pt-4">
                <button
                  ...
                  onClick={closeMentorModal}
                  disabled={creatingMentor}
                  className="rounded-xl px-4 py-2.5 text-xs font-semibold text-[#7A7F85] transition hover:bg-gray-100 disabled:opacity-50"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={creatingMentor}
                  className="inline-flex items-center gap-2 rounded-xl bg-[#1A3D63] px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-[#4A7FA7] disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {creatingMentor && (
                    <Loader2 className="h-3.5 w-3.5 animate-spin" />
                  )}
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <div className="mt-5 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs text-amber-700">
              <strong>Important:</strong> This temporary password is sent to email.
            </div>
