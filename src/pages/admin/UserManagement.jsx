  ...
  return (
    <div className="min-h-screen bg-[#F6FAFD] p-6 sm:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex flex-col gap-4 border-b border-gray-200 pb-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="relative flex-1 sm:w-72 lg:max-w-md">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-white py-2 pl-9 pr-4 text-xs outline-none focus:border-[#4A7FA7] focus:ring-2 focus:ring-[#B3CFE5]"
            />
          </div>
        </div>
        ...
        {/* USERS TABLE */}
        {loading ? (
          <div className="flex h-60 items-center justify-center border-y border-gray-200 bg-white">
          ...
          <div className="border-y border-dashed border-[#B3CFE5] bg-white p-12 text-center">
            {activeTab === "students" ? (
              ...
              <table className="w-full min-w-[1050px] border-collapse">
                <thead>
                  <tr className="border-b border-gray-200 bg-[#F6FAFD]">
                    <th className="px-5 py-4 text-left text-[11px] font-black uppercase tracking-wider text-[#7A7F85]">
                      User
                    </th>
                    ...
                    <th className="px-5 py-4 text-right text-[11px] font-black uppercase tracking-wider text-[#7A7F85]">
                      Actions
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredUsers.map((user) => (
                    <tr
                      key={user._id}
                      className="transition hover:bg-[#F6FAFD]/70"
                    >
                      {/* USER */}
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-3">
                          {user.profileImage?.url ? (
                            ...
                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#EAF3F9] text-sm font-black text-[#1A3D63]">
                              {user.firstName
                          ...
                          <div className="min-w-0">
                            ...
                            {user.batch?.name && (
                              <span className="mt-1 inline-block rounded-md bg-[#F6FAFD] px-2 py-0.5 text-[10px] font-bold text-[#4A7FA7]">
                                {user.batch.name}
                              </span>
                            )}
                          </div>
                      ...
                      <td className="px-5 py-4">
                        <div className="space-y-1.5">
                          <div className="flex max-w-[230px] items-center gap-2 text-xs text-[#4A7FA7]">
                          ...
                          {user.phone && (
                            <div className="flex items-center gap-2 text-xs text-[#7A7F85]">
                          ...
                          {user.assignedMentors?.length > 0 ? (
                            <div className="flex max-w-[250px] flex-wrap gap-1.5">
                              {user.assignedMentors.map((mentor) => (
                                <span
                                  key={mentor._id}
                                  className="rounded-md border border-gray-200 bg-white px-2 py-1 text-[10px] font-semibold text-[#1A3D63]"
                                >
                                  {mentor.firstName
                                    ? `${mentor.firstName} ${
                                        mentor.lastName || ""
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            disabled={actionId === user._id}
                            className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold text-red-600 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
                            title="Delete user"
                          >
                            {actionId === user._id ? (
                              <Loader2 className="h-3.5 w-3.5 animate-spin" />
