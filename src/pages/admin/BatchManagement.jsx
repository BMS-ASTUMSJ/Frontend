...
function BatchManagement() {
  ...
  const handleCreateBatch = async (e) => {
    ...
    try {
      ...
      toast.success(
        response.data?.message || "Batch created successfully.",
      );
...
=======
        {/* MAIN CONTENT */}
>>>>>>> a3afb3130ba521def42daf441c8af595af1e9409
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-xl border border-[#B3CFE5] bg-[#F6FAFD] px-3 py-3 text-sm outline-none focus:border-[#1A3D63]"
                  />
                </div>
                ...
                >
                  <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[#F6FAFD] text-[#1A3D63]">
