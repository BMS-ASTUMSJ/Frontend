  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        {/* ================= LOADING ================= */}
        {loading ? (
          <div className="flex min-h-[400px] flex-col items-center justify-center rounded-3xl border border-gray-100 bg-white shadow-sm">
          ...
          /* ================= EMPTY ================= */
          <div className="flex min-h-[400px] flex-col items-center justify-center rounded-3xl border border-gray-100 bg-white p-10 text-center shadow-sm">
...
const BatchCard = ({ batch, onViewReport }) => {
  ...
  // Calculate an overall rate based on the gender groups.
  ...
  return (
    <div className="group overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      {/* Overall percentage */}
      <div className="border-b border-gray-100 bg-gradient-to-br from-indigo-50 to-white p-6">
