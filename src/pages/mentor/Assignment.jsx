...
const Assignment = () => {
  ...
  // ============================================================
  // VIEW DETAILS (ADDED FROM STUDENT ASSIGNMENT)
  // ============================================================
  ...
  // ============================================================
  // HELPERS (ADDED FROM STUDENT ASSIGNMENT)
  // ============================================================
  ...
  return (
    <div className="min-h-screen bg-[#F6FAFD] p-6">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            {/* View Details button synced from student assignment */}
                            <button
                              type="button"
                              onClick={() => openDetailsModal(assignment)}
                              className="mt-2 text-xs font-semibold text-[#1A3D63] hover:underline block"
                            >
                              View Details
                            </button>
                          </div>
      ...
      {/* ==========================================================
          ASSIGNMENT DETAILS MODAL (SYNCED FROM STUDENT VIEW)
      ========================================================== */}
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-[#7A7F85]">
                  {detailsAssignment.assignmentType === "mentor"
