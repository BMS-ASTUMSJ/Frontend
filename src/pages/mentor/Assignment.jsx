...
const Assignment = () => {
  ...
  const handleCreateAssignment = async (e) => {
    ...
    try {
      ...
      if (createFile) formData.append("files", createFile);
        ...
        <div className="max-w-7xl mx-auto mt-8 transition-all animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-bold text-[#8FA3B0] bg-white px-3 py-1 rounded-full border border-[#B4D7E2]/50">
              {submissions.length} Total Submisiions
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      type="number"
                      placeholder="0"
                      className="w-32 p-3 bg-[#F4F8FA] border border-[#B4D7E2] focus:border-[#00A8CC] rounded-2xl font-black text-center text-sm outline-none"
                      value={score}
                      onChange={(e) => setScore(e.target.value)}
                    />
                    <span className="text-xs font-bold text-[#8FA3B0]">
                ...
                {selectedAssignmentType === "admin" ? (
                  <>
                    <button
                      ...
                      className="px-5 py-3 text-amber-600 bg-amber-50 hover:bg-amber-100 font-black text-xs uppercase rounded-2xl transition border border-amber-200"
                    >
                      Resubmission
                    </button>
                    <button
                      ...
                      className="px-7 py-3 bg-[#14222B] hover:bg-[#1b3c47] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-gray-200 transition flex items-center gap-2"
                    >
                      {grading ? (
                  ...
                  <button
                    ...
                    className="px-7 py-3 bg-[#00A8CC] hover:bg-[#0092b3] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-[#00A8CC]/20 transition flex items-center gap-2"
                  >
                    {feedbackSaving ? (
                      <Loader2 size={16} className="animate-spin" />
                    ) : (
          ...
          <div className="bg-[#e6f9fd] w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#00A8CC]/30">
            ...
            <div className="space-y-3 mb-8">
              ...
              {detailsAssignment.files?.map((file, i) => (
                ...
                >
                  <FileText size={15} className="text-[#00A8CC]" /> Attached
                  Document {i + 1}
                </a>
              ))}
            </div>
